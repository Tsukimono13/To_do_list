...
export const todolistReducer = (state = initialState, action: MainTodolistACType) => {
    switch (action.type) {
...
export type MainTodolistACType = removeTodolistACType | addTodolistACType | updateTodolistACType | changeFilterACType
